...
module.exports = {
  ...
  plugins: [
    ...
    function({ addUtilities, addComponents, theme }) {
      ...
      addComponents({
        '.mobile-card': {
          '@apply bg-card border border-border rounded-mobile shadow-mobile p-4': {},
        },
        '.mobile-button': {
          '@apply touch-manipulation tap-highlight-none select-none': {},
        },
        '.mobile-input': {
          '@apply touch-manipulation tap-highlight-none': {},
        },
        '.mobile-container': {
          '@apply mx-auto px-4 max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl': {},
        },
        '.mobile-grid': {
